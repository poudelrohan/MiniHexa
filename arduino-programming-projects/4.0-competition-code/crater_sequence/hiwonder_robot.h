...
class Robot {
  public:
     ...
     *        Leg pairs step in order: rear (3,4) → middle (2,5) → front (1,6).
     *        4 legs are always grounded while 2 swing.
     *        Designed for maximum traction on slippery slopes.
     *
     * @param enabled     - true = caterpillar, false = default tripod
     * @param lift_rear   - lift height for rear legs (3, 4) — default 7
     * @param lift_mid    - lift height for middle legs (2, 5) — default 4
     * @param lift_front  - lift height for front legs (1, 6) — default 2
     */
