      ...
      switch(move_state) {
        case MOVING:
          ...
          if (caterpillar_mode) {
            ...
            // swing_phase: rear(1,6)=0, mid(2,5)=1, front(3,4)=2
            const int   sp[6]    = { 0, 1, 2, 2, 1, 0 };
            // per-leg lift height: rear=7, mid=4, front=2
...
void Robot::set_caterpillar(bool enabled, float lift_rear, float lift_mid, float lift_front) {
