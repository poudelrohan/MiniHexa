      ...
      switch(move_state) {
        case MOVING:
          ...
          if (wave_gait_mode) {
            ...
            // Actual physical positions (Y coordinate):
            ...
            //
            // Tripod A swings first (legs 1=rear-R, 3=front-R, 5=mid-L)
            // Tripod B swings second (legs 2=mid-R,  4=front-L, 6=rear-L)
            ...
            if(tick_count > (move_time / 4) && tick_count < (3 * move_time / 4)) {
              ...
              leg4.trajectory_point.z = leg4.result.z - _lift_front * cos_val;  // front
              leg6.trajectory_point.z = leg6.result.z - _lift_rear  * cos_val;  // rear
            } else {
              // Tripod B grounded, Tripod A swinging
              leg1.trajectory_point.z = leg1.result.z + _lift_rear  * cos_val;  // rear
              leg3.trajectory_point.z = leg3.result.z + _lift_front * cos_val;  // front
