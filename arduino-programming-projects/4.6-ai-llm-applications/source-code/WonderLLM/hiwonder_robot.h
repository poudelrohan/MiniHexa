...
class Robot {
  public:
    ...
    /**
     * @brief Obstacle avoidance (configurable distance)
     * 
     * @param  dis  - measured current distance
     * @param  dis_avoid  - avoidance distance threshold
     */
    ...
    /**
     * @brief Read robot center of gravity coordinates
     * 
     * @param *val - pointer to read coordinate values
     */
